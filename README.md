...
![Image description](https://github.com/redhat2410/arduino_build/tree/develop/img/Layout.PNG?raw=true)
...
![Image description](https://github.com/redhat2410/arduino_build/tree/develop/img/esp.jpg?raw=true)
- Trong quá trình biên dịch, trình biên dịch sẽ hỏi bạn "Do you want to upload (Y/N)", bạn trả lời "Y" khi muốn nạp chương trình cho vi điều khiển, ngược lại "N" khi bạn chỉ muốn build chương trình.
